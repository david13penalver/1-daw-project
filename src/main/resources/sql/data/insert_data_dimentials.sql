...
insert INTO card VALUES (14, 'Frogan', '... Apparently, the Frogan need to be submerged in liquid lava to survive. Through the skin they absorb minerals and volcanic energies that influence their correct metabolism and health. A Frogan away from the lava will develop a fragile and delicate horn ... " Extract from Eron Vulk's D.I.', '... Al parecer, los Frogan necesitan sumergirse en lava líquida para sobrevivir. A través de la piel absorben minerales y energias volcánicas que influyen en su correcto metabolismo y salud. Un Frogan alejado de la lava desarrollará una cornamenta frágil y delicada..." Extracto del D.I de Eron Vulk', 10.00, '/images/CardDetail/card14.png');
